...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "APPLICATION FOR USER PRIZES"
    PROJECT_DESCRIPTION: str = "Backend of test application for working with users and their prizes"
    PROJECT_VERSION: str = "1.1.1"
    API_V1_ENDPOINT: str = "/api/v1"

    DATABASE_URL: str = "sqlite://sqlite3.db"

    SECRET_KEY: str = 'PUSTOTESTPRIZES'
    ALGORITHM: str = "HS256"
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60 * 24  # 1 day

    DEFAULT_ADMIN_USERNAME: str = 'admin'
    DEFAULT_ADMIN_EMAIL: str = 'admin@mail.com'
